...
![Codex 沙盒、审批策略、审批人与配置项关系图](../images/imported/codexguide__docs__.vuepress__public__images__codex-safety-layers.svg)
...
![Codex 配置中的沙盒设置选项](../images/imported/codexguide__docs__images__codex-config-sandbox-settings-watermarked-small.png)
...
![Codex 配置中的审批策略选项](../images/imported/codexguide__docs__images__codex-config-approval-policy-watermarked-small.png)
