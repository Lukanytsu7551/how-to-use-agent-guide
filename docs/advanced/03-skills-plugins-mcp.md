...
![codex-skills-plugins-entry-page](../images/imported/codexguide__docs__images__codex-skills-plugins-entry-page.png)
...
![codex-skills-list](../images/imported/codexguide__docs__images__codex-skills-list.png)
...
![codex-skills-slash-command-list](../images/imported/codexguide__docs__images__codex-skills-slash-command-list.png)
...
![codex-plugins-at-command-list](../images/imported/codexguide__docs__images__codex-plugins-at-command-list.png)

安装或导入插件时，Codex 通常会要求你确认来源和能力范围：

![codex-plugin-install-github-prompt](../images/imported/codexguide__docs__images__codex-plugin-install-github-prompt.png)
