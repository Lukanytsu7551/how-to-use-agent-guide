...
![Codex App 权限选择器示例](../images/imported/codexguide__docs__images__codex-app-permissions-selector-menu-watermarked-small.png)
...
![Codex App 自动审核拒绝高风险操作示例](../images/imported/codexguide__docs__images__codex-app-auto-review-rejection-watermarked-small.png)
...
![Codex App config.toml 配置示例](../images/imported/codexguide__docs__images__codex-app-config-toml-settings-watermarked-small.png)
