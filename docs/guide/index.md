---
description: "How to Use Codex 学习路线，围绕说清楚、执行、验证、交付的闭环展开，帮助读者找到适合自己的入口。"
---

# 学习路线

欢迎来到 How to Use Codex。本网站提供面向初学者的 Codex **快速上手**栏目，也提供面向长期使用和团队落地的**进阶教程**与**实战案例**。
...
本教程近期正在积极改进中。如果有修改建议，欢迎提出 issue。反馈会得到及时处理。
...
学了许多知识却无从下手？How to Use Codex 提供了 17 个真实场景的示例，帮助你学习真实的 Codex 工作流经验：
- 用 PPT Skill 生成演示文稿
...
如果你想参与维护，可以从修正文档、补充验证步骤、提交真实案例和同步官方资料变化开始。
