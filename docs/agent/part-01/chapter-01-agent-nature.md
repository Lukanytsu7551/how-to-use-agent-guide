---
description: "Agent Guide 第 1 章：Agent 的本质。"
containerClass: agent-guide-page
---

# 第 1 章：Agent 的本质

区分普通问答、工作流与 Agent，理解自主性来自哪里。

## 本章要解决什么

当系统需要持续判断下一步时，什么才算 Agent？
...
本章属于 **Part 1 / Agent 基础**。读完后，回到本 Part 概述页整理自己的知识卡，再进入下一章。
