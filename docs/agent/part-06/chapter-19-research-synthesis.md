---
description: "Agent Guide 第 19 章：Research-Synthesis。"
containerClass: agent-guide-page
---

# 第 19 章：Research-Synthesis

把检索、证据筛选、观点比较和最终综合组织成可复核的研究流程。

## 本章要解决什么

如何区分资料、推断和结论，避免研究结果看似完整却无法核验？
...
本章属于 **Part 6 / 协作式推理**。读完后，回到本 Part 概述页整理自己的知识卡，再进入下一章。
