---
description: "Agent Guide 第 5 章：Skills 技能系统。"
containerClass: agent-guide-page
---

# 第 5 章：Skills 技能系统

把稳定的任务方法、提示、脚本和参考资料封装成可复用能力。

## 本章要解决什么

一个 Skill 和一段 Prompt、一个工具有什么区别？
...
把一次重复任务整理成 Skill 目录，写出输入、步骤、输出和验收标准。
...
本章属于 **Part 2 / 工具与扩展**。读完后，回到本 Part 概述页整理自己的知识卡，再进入下一章。
