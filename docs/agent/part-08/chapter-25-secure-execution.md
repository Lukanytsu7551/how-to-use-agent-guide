---
description: "Agent Guide 第 25 章：安全执行。"
containerClass: agent-guide-page
---

# 第 25 章：安全执行

隔离不可信输入和高风险操作，降低提示注入、越权和误执行风险。

## 本章要解决什么

怎样让 Agent 能做事，同时不能任意改变外部系统？
...
列出一个文件操作 Agent 的威胁模型，并设计最小权限和回滚方案。
...
本章属于 **Part 8 / 企业治理与安全**。读完后，回到本 Part 概述页整理自己的知识卡，再进入下一章。
