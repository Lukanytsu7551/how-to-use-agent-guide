---
description: "Agent Guide 第 7 章：上下文工程。"
containerClass: agent-guide-page
---

# 第 7 章：上下文工程

把规则、资料、历史和工具结果组织成模型真正用得上的上下文。

## 本章要解决什么

上下文越多越好吗？哪些信息应该被压缩或移出？
...
本章属于 **Part 3 / 上下文与记忆**。读完后，回到本 Part 概述页整理自己的知识卡，再进入下一章。
