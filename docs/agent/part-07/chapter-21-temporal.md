---
description: "Agent Guide 第 21 章：Temporal 工作流。"
containerClass: agent-guide-page
---

# 第 21 章：Temporal 工作流

理解持久化工作流、重试、定时和恢复对长任务的价值。

## 本章要解决什么

Agent 中断后如何从正确的检查点继续，而不是从头再来？
...
本章属于 **Part 7 / 生产级架构**。读完后，回到本 Part 概述页整理自己的知识卡，再进入下一章。
