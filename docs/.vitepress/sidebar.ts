...
const workbuddyItems: DefaultTheme.SidebarItem[] = [
  ...
  bluebookVolume("快速上手", "第一篇 使用手册：先把 WorkBuddy 用起来", [
    ...
    ["08 / 接入助理和小程序", "第 8 章 WorkBuddy 接入小程序与 IM 助理"],
  ...
  bluebookVolume(
    ...
    [
      ...
      ["11 / WorkBuddy 也能做 GEO 专家", "第 21 章 WorkBuddy也能做GEO专家"],
    ],
    [item("100 个真实案例库", "/workbuddy/case-library/")],
  ),
  bluebookCombinedVolume("进阶教程", "第三篇 进阶篇：把案例变成自己的工作系统", [
    ["第三篇 进阶篇：把案例变成自己的工作系统", "01 / 打造 Skill：将书和视频蒸馏为可执行 Skill", "第 22 章 打造skill：将书和视频蒸馏为可执行 Skill"],
