...
![notion-mcp-plugin-search](../images/imported/codexguide__docs__images__notion-mcp-plugin-search.png)
...
![notion-mcp-authorization](../images/imported/codexguide__docs__images__notion-mcp-authorization.png)
...
![notion-mcp-workspace-read-result](../images/imported/codexguide__docs__images__notion-mcp-workspace-read-result.png)
...
![notion-mcp-updated-content-query-result](../images/imported/codexguide__docs__images__notion-mcp-updated-content-query-result.png)

### 总结与写入

读取到内容之后，可以让 Codex 直接进行总结。如果对话中产生了不错的想法，也可以让它**直接写入到你的 Notion 工作空间**，完成后会返回一个写入成功的链接：

![notion-mcp-write-summary-result](../images/imported/codexguide__docs__images__notion-mcp-write-summary-result.png)

点击链接跳转到 Notion 查看写入结果，内容完全正常：

![notion-mcp-created-summary-page](../images/imported/codexguide__docs__images__notion-mcp-created-summary-page.png)
