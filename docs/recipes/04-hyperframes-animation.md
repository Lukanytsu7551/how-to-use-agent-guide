...
![hyperframes-plugin-search](../images/imported/codexguide__docs__images__hyperframes-plugin-search.png)
...
![hyperframes-book-content-prompt](../images/imported/codexguide__docs__images__hyperframes-book-content-prompt.png)

任务完成之后，它会告诉我们**返回本地文件的地址**，点击即可跳转查看具体内容。

![hyperframes-local-output-summary](../images/imported/codexguide__docs__images__hyperframes-local-output-summary.png)

如果你仔细观察，会发现实际上它是**生成了几张 JPEG 格式的图片，然后将图片组装成视频**。大概是这样一个过程。

![hyperframes-generated-frame-files](../images/imported/codexguide__docs__images__hyperframes-generated-frame-files.png)
...
![hyperframes-refinement-prompt](../images/imported/codexguide__docs__images__hyperframes-refinement-prompt.png)
