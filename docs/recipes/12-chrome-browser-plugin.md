...
![chrome-codex-extension-page-summary-prompt](../images/imported/codexguide__docs__images__chrome-codex-extension-page-summary-prompt.png)

第一次点击后会跳转到浏览器插件安装页，点击添加扩展即可

![chrome-web-store-codex-extension](../images/imported/codexguide__docs__images__chrome-web-store-codex-extension.png)
...
![chrome-codex-extension-summary-result](../images/imported/codexguide__docs__images__chrome-codex-extension-summary-result.png)
