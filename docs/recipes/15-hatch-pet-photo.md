...
![image.png](../images/imported/yanyan__20260603164239865.png)
...
![image.png](../images/imported/yanyan__20260603165113247.png)

Codex 会自动完成风格转换、生成帧数、添加动画效果。

![image.png](../images/imported/yanyan__20260603165417268.png)

生成过程中会显示进度提示：

![image.png](../images/imported/yanyan__20260603170909630.png)
...
![image.png](../images/imported/yanyan__20260603171016784.png)

最终效果：

![image.png](../images/imported/yanyan__20260603171438425.png)

生成后的动画效果可以在 Codex 的自定义宠物列表和输出目录中查看。

宠物包输出位置：

![](../images/imported/yanyan__20260603180110711.png)
...
![image.png](../images/imported/yanyan__20260603174027962.png)
