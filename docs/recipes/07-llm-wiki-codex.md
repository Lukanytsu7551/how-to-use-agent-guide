...
![llm-wiki-concept-diagram](../images/imported/codexguide__docs__images__obsidian-codex-llm-wiki-concept-image.png)
...
![llm-wiki-codex-create-vault-command](../images/imported/codexguide__docs__images__llm-wiki-codex-create-vault-command.png)
...
![llm-wiki-obsidian-web-clipper-search](../images/imported/codexguide__docs__images__llm-wiki-obsidian-web-clipper-search.png)

### 抓取文章到 raw 文件夹

找一篇想纳入知识库的文章，用插件将其保存到仓库里的 `raw/` 文件夹（在 Karpathy 的理念中，`raw/` 专门存放原始素材）。点击"添加到 Obsidian"即可。

![llm-wiki-clip-article-to-raw](../images/imported/codexguide__docs__images__llm-wiki-clip-article-to-raw.png)

### 让 Codex 完成入库

打开 Obsidian，让 Codex 读取这篇文章：

![llm-wiki-codex-import-article-prompt](../images/imported/codexguide__docs__images__llm-wiki-codex-import-article-prompt.png)

Codex 会自动阅读内容，按照 LLM Wiki 的理念进行拆分，新增摘要、实体、关联引用等页面。完成后，它会告诉你具体新增了哪些内容，这篇文章就正式入库了。

![llm-wiki-codex-generated-pages](../images/imported/codexguide__docs__images__llm-wiki-codex-generated-pages.png)
