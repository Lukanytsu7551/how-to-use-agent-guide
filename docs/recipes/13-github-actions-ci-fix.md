...
![github-actions-workflow-failure-list](../images/imported/codexguide__docs__images__github-actions-workflow-failure-list.png)

点进去看报错：

![github-actions-failing-test-log](../images/imported/codexguide__docs__images__github-actions-failing-test-log.png)
...
![github-actions-workflow-annotations](../images/imported/codexguide__docs__images__github-actions-workflow-annotations.png)
...
![github-actions-workflow-permissions-settings](../images/imported/codexguide__docs__images__github-actions-workflow-permissions-settings.png)
...
![github-actions-auto-fix-pr-list](../images/imported/codexguide__docs__images__github-actions-auto-fix-pr-list.png)

点进去看它改了什么：

![github-actions-discount-fix-diff](../images/imported/codexguide__docs__images__github-actions-discount-fix-diff.png)
