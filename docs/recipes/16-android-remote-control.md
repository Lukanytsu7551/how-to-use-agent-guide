...
![安全设置](../images/imported/yanyan__20260527154702248.png)

![验证器应用|96](../images/imported/yanyan__20260527154950497.png)

将显示的验证码复制到验证器应用（推荐 Google Authenticator 或 Microsoft Authenticator），然后输入返回的 6 位动态验证码。

![输入验证码](../images/imported/yanyan__20260527155059740.png)
...
![开始设置](../images/imported/yanyan__20260527145931186.png)
...
![选择安卓](../images/imported/yanyan__20260527150702223.png)

扫码后手机会显示以下界面：

![扫码结果](../images/imported/yanyan__20260527152034359.png)
...
![等待响应](../images/imported/yanyan__20260527152239430.png)
...
![授权设备](../images/imported/yanyan__20260527155313105.png)
...
![连接成功](../images/imported/yanyan__20260527143924648.png)
...
![手机端项目列表](../images/imported/yanyan__20260527152442784.png)

**电脑端查看：** 点击 Codex 左下角的手机图标 → 点击「管理连接」→ 查看已连接的安卓设备。

![电脑端管理连接](../images/imported/yanyan__20260527152745840.png)

![已连接设备](../images/imported/yanyan__20260527153008463.png)
...
![连接失败](../images/imported/yanyan__20260527153330947.png)
...
![image.png](../images/imported/yanyan__20260527160714918.png)
