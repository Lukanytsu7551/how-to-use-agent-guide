...
![feishu-cli-install-result](../images/imported/codexguide__docs__images__feishu-cli-install-result.png)
...
![feishu-cli-create-app-prompt](../images/imported/codexguide__docs__images__feishu-cli-create-app-prompt.png)

打开链接，创建应用：

![feishu-cli-create-custom-app-modal](../images/imported/codexguide__docs__images__feishu-cli-create-custom-app-modal.png)

按照它的指引创建应用之后，把 App ID 和 App Secret 发给它，Codex 会自动完成飞书应用配置和权限申请。

![feishu-cli-doc-export-tools-result](../images/imported/codexguide__docs__images__feishu-cli-doc-export-tools-result.png)

> 过程中会涉及**手动授权**操作。Codex 会提供跳转链接，点击在浏览器里放行对应权限即可，这样它才能读取和操作你的飞书数据。

![feishu-cli-oauth-login-link](../images/imported/codexguide__docs__images__feishu-cli-oauth-login-link.png)
...
![feishu-cli-document-list-result](../images/imported/codexguide__docs__images__feishu-cli-document-list-result.png)

Codex 还会贴心地告诉你第一次应该怎么用，连提示词都帮你准备好了。

![feishu-cli-command-examples](../images/imported/codexguide__docs__images__feishu-cli-command-examples.png)
...
![feishu-cli-image-generation-prompt](../images/imported/codexguide__docs__images__feishu-cli-image-generation-prompt.png)
...
![feishu-cli-generated-image-preview](../images/imported/codexguide__docs__images__feishu-cli-generated-image-preview.png)
