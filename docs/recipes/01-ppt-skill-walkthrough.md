...
![ppt-skill-install-prompt](../images/imported/codexguide__docs__images__ppt-skill-install-prompt.png)
...
![ppt-skill-installation-result](../images/imported/codexguide__docs__images__ppt-skill-installation-result.png)
...
![ppt-skill-user-input-menu](../images/imported/codexguide__docs__images__ppt-skill-user-input-menu.png)

当你补齐背景、主题、受众或风格要求后，它会按该 Skill 的流程去读取 README、模板和相关文档，再生成结果。

![ppt-skill-generated-file-result](../images/imported/codexguide__docs__images__ppt-skill-generated-file-result.png)

如果这个 Skill 的默认产物是 HTML 演示稿，你通常可以直接在 Codex 内置浏览器里打开预览。

![ppt-skill-html-preview](../images/imported/codexguide__docs__images__ppt-skill-html-preview.png)
