...
本页先覆盖 Codex CLI 的安装与登录。桌面端、ChatGPT、Cloud 和 IDE 入口会在 [入口地图](./01-what-is-codex.md) 中分别展开。
...
![codex-cli-prerequisite-version-check](../images/imported/codexguide__docs__images__codex-cli-prerequisite-version-check.png)
...
![codex-cli-version-check](../images/imported/codexguide__docs__images__codex-cli-version-check.png)
...
![codex-cli-login-account-selection](../images/imported/codexguide__docs__images__codex-cli-login-account-selection.png)
...
![codex-cli-readonly-first-task](../images/imported/codexguide__docs__images__codex-cli-readonly-first-task.png)
