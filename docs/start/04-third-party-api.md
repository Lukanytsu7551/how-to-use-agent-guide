...
![Teamo 客户端登录和注册界面](../images/imported/blog__Teamo-1.png)
...
![Teamo 客户端一键接入 Codex 状态](../images/imported/blog__Teamo-2.png)
...
![Codex 中选择 TeamoRouter 模型](../images/imported/blog__Teamo-3.png)
...
![](../images/imported/blog__20260529172147.png)
...
![](../images/imported/blog__20260529165811.png)
...
![](../images/imported/blog__20260529170535.png)
...
![](../images/imported/blog__20260529171249.png)
...
![](../images/imported/blog__20260529171601.png)
...
![](../images/imported/blog__20260529170927.png)
...
![](../images/imported/blog__20260529171743.png)
...
![](../images/imported/blog__20260529172239.png)

会有 「Codex++ 管理工具」和 「Codex++ app」两个安装包。

![](../images/imported/blog__ca6415f0ad1e10755f656001d16d91d5.png)
...
![](../images/imported/blog__b265fd82e492107e53dc7b0df6af553c.png)
不要慌，先打开「系统设置」-「隐私与安全性」，点击「仍要打开」：

![](../images/imported/blog__3e514cfc66a2a76536dbfc5c37743315.png)

打开后就会进入到这个管理界面：

![](../images/imported/blog__f33b0f1f6377c237f113000a0ec0637f.png)

同样的方式，安装刚才安装包中的 Codex++ app。你就可以看到管理工具检测全绿了。

![](../images/imported/blog__e0ca6498f640c984c438527f13faf435.jpg)
...
![](../images/imported/blog__d13c6d3d480af07b22cc8b7b470a45e5.jpg)

模型列表可以选择从上游获取，如果你配置的是中转站，这里就可以用很多不同的模型了：

![](../images/imported/blog__0c4dd861837c8686d3135b704ae4517d.jpg)

可以看到这个工具做的就是帮你更方便的写入配置。

![](../images/imported/blog__9132822e751d0eccd37b79bbe0d6b3b0.jpg)

保存后可以测试联通情况，没问题，直接选择使用：

![](../images/imported/blog__728d1e4564ea5f78121cae63fd94790a.jpg)

3. 从 `Codex++` 入口启动 Codex，而不是从原版 Codex 入口启动。

![](../images/imported/blog__cb577d3e36171a7204e291500a7db9dc.jpg)

重新启动后，你就能看到现在 Codex已经完全使用了我们自定义的模型供应商，并可以选择更多的模型。

![](../images/imported/blog__151adfc6f7cd994b58815787999a5c37.jpg)

其中插件也可以直接使用了：

![](../images/imported/blog__66afdc2191cadafa60171ef81940733d.jpg)
