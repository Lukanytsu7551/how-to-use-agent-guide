...
![Hero SMS 注册验证码平台示例](../images/imported/codexguide__docs__images__subscribe-hero-sms-watermarked-small.png)
...
![支付宝购买苹果礼品卡示例](../images/imported/codexguide__docs__images__subscribe-apple-gift-card-watermarked-small.jpg)

给Apple id充值礼品卡：

![Apple ID 兑换礼品卡示例](../images/imported/codexguide__docs__images__subscribe-apple-id-redeem-watermarked-small.jpg)
...
![App Store Price 提供的 ChatGPT Plus 各区价格对比示例](../images/imported/codexguide__docs__images__subscribe-appstoreprice-chatgpt-price-watermarked-small.webp)
...
![土耳其节点 IP 检测示例](../images/imported/codexguide__docs__images__subscribe-appstoreprice-ip-check-watermarked-small.webp)
...
![Apple ID 注册页面示例](../images/imported/codexguide__docs__images__subscribe-appstoreprice-apple-id-signup-watermarked-small.webp)
...
![App Store 账户 Payment Address 示例](../images/imported/codexguide__docs__images__subscribe-appstoreprice-payment-address-watermarked-small.webp)
...
![Oyunfor 礼品卡选择页面示例](../images/imported/codexguide__docs__images__subscribe-appstoreprice-gift-card-watermarked-small.webp)

::: warning
How to Use Codex 不推荐具体商家，也不保证任何第三方礼品卡渠道的稳定性。礼品卡一旦兑换通常不可退款，建议先小额测试。
:::
...
![Oyunfor 支付方式选择示例](../images/imported/codexguide__docs__images__subscribe-appstoreprice-payment-method-watermarked-small.webp)

随后进入支付页，填写银行卡信息并确认付款。源文里的银行卡信息已经做了遮挡；你自己操作时不要把银行卡、验证码、礼品卡兑换码截图发给任何人。

![银行卡支付页面示例](../images/imported/codexguide__docs__images__subscribe-appstoreprice-card-payment-watermarked-small.webp)

如果银行或支付通道要求 3D Secure / 短信验证码，按页面提示完成验证。

![银行卡验证码验证页面示例](../images/imported/codexguide__docs__images__subscribe-appstoreprice-card-verify-watermarked-small.webp)

**第七步：收取并兑换礼品卡**

付款成功后，礼品卡通常会通过邮件发送。源文的邮件截图中露出了兑换码，所以这里不再放图。拿到兑换码后，打开 App Store，点击头像，进入「兑换礼品卡或代码」，把土耳其区礼品卡兑换到同一个土耳其区 Apple ID。

![App Store 兑换礼品卡示例](../images/imported/codexguide__docs__images__subscribe-appstoreprice-redeem-watermarked-small.webp)
