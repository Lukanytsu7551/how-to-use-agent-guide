...
![搜索并安装 Codex 插件](../images/imported/codexguide__docs__images__vscode-codex-extension-marketplace.png)

## 打开插件对话窗口

安装完成后，在 VS Code 中打开任意一个项目文件，右上角会出现 ChatGPT 的图标。点击该图标，右侧边栏就会展开 Codex 的对话窗口。

![文件右上角的插件图标](../images/imported/codexguide__docs__images__vscode-codex-extension-icon.png)

![展开后的对话窗口](../images/imported/codexguide__docs__images__vscode-codex-chat-panel.png)
...
![使用 @ 指定文件](../images/imported/codexguide__docs__images__vscode-codex-file-reference.png)
