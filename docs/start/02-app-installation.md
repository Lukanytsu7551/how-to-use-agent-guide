...
![Codex 桌面 App 下载页 macOS](../images/imported/codexguide__docs__images__codex-app-download-macos-options.png)
...
![Codex 桌面 App 下载页 Windows](../images/imported/codexguide__docs__images__chatgpt-codex-get-started-clean.png)
