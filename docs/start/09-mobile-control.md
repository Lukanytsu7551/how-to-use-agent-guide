...
![ChatGPT 手机 App 中的 Codex 入口](../images/imported/codexguide__docs__images__mobile-codex-ios-app-watermarked-small.jpg)

连接桌面 Codex APP：

![手机端连接桌面 Codex App](../images/imported/codexguide__docs__images__mobile-codex-connect-desktop-watermarked-small.jpg)

在 ChatGPT 里打开 Codex 就能用。

![在 ChatGPT 手机 App 中打开 Codex](../images/imported/codexguide__docs__images__mobile-codex-chatgpt-entry-watermarked-small.jpg)
