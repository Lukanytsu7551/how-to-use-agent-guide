...
![Codex 使用入口地图](../images/imported/codexguide__docs__.vuepress__public__images__codex-surfaces.svg)
...
4. 阅读 [CLI 选项](./12-cli-options.md) 和 [config.toml](../advanced/09-config-toml.md)，补上配置基本功。
...
| CLI 选项 | CLI | [CLI 选项与命令](./12-cli-options.md) |
